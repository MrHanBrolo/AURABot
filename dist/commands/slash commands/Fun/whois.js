...
exports.default = {
    ...
    callback: ({ interaction: msgInt, channel, message }) => __awaiter(void 0, void 0, void 0, function* () {
        var _a, _b, _c;
        try {
            // Functions
            ...
            */
            ...
            !userBg ? bg = yield (0, skia_canvas_1.loadImage)('./wallpaper/AURABotWhoIsBG.png') : bg = yield (0, skia_canvas_1.loadImage)(userBg);
            //Dark grey rect
            ...
            */
            ...
            const reply = yield msgInt.reply({ files: [attachment], components: [flipBackRow], fetchReply: true });
            //FLIP BUTTON
            const filter = (btnInt) => {
            ...
            collector.on("end", (collection) => __awaiter(void 0, void 0, void 0, function* () {
                var _d, _e;
                if (((_d = collection.last()) === null || _d === void 0 ? void 0 : _d.customId) == "flipBack") {
                    yield msgInt.editReply({ embeds: [backCard], attachments: [], components: [flipDisabledFront] });
                }
                if (((_e = collection.last()) === null || _e === void 0 ? void 0 : _e.customId) == "flipFront") {
                    yield msgInt.editReply({ embeds: [], files: [attachment], components: [flipDisabledBack] });
                }
                if (collection.last() == undefined) {
                    yield msgInt.editReply({ components: [flipDisabledBack] });
                }
            }));
        }
        catch (error) {
